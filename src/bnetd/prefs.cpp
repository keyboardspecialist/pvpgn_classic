...
namespace pvpgn
{
	...
	namespace bnetd
	{
		...
		static int conf_set_d2cs_charinfo_dir(const char *valstr);
		static const char *conf_get_d2cs_charinfo_dir(void);
		static int conf_setdef_d2cs_charinfo_dir(void);
		...
		static t_conf_entry conf_table[] =
		{
			...
			{ "d2cs_charinfo_dir", conf_set_d2cs_charinfo_dir, conf_get_d2cs_charinfo_dir, conf_setdef_d2cs_charinfo_dir },
		...
		extern char const * prefs_get_d2cs_charinfo_dir(void)
		{
			return prefs_runtime_config.d2cs_charinfo_dir;
		}

		static int conf_set_d2cs_charinfo_dir(const char *valstr)
		{
			return conf_set_str(&prefs_runtime_config.d2cs_charinfo_dir, valstr, NULL);
		}

		static int conf_setdef_d2cs_charinfo_dir(void)
		{
			return conf_set_str(&prefs_runtime_config.d2cs_charinfo_dir, NULL, BNETD_D2CS_CHARINFO_DIR);
		}
