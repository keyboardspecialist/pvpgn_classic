...
#define CLIENT_D2CS_CHARLISTREQ_100		0x10
	typedef struct
	{
		t_d2cs_client_header	h;
	} t_client_d2cs_charlistreq_100;

#define D2CS_CLIENT_CHARLISTREPLY_100		0x10
	typedef struct
	{
		t_d2cs_client_header	h;
		bn_byte			reserved;
		bn_short		total_length;
		bn_short		current_length;
		bn_short		continuation;
		/* assembled character-list data */
	} t_d2cs_client_charlistreply_100;
